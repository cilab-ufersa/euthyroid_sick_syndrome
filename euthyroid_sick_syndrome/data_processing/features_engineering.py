...
if __name__ == '__main__':
    ...
    dataset = pd.read_csv('/home/vinicius/UFERSA/cilab/euthyroid_sick_syndrome/euthyroid_sick_syndrome/datasets/euthyroid/euthyroid_clean.csv')
    ...
    for i in dataset:
        dataset[i]= dataset[i].astype("category").cat.codes.values
